    ...
    <script>
        ...
        const getHistories = async () => {
            try {
                ...
                console.log('responsePresenters',responsePresenters);
                console.log('responseDatabase',responseDatabase);
                console.log('presenters',presenters);
                console.log('pmbVal',pmbVal);
                
                console.log("API response:", responseDatabase.data);
