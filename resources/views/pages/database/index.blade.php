                ...
                <div class="flex items-center gap-2">
                    @if (Auth::user()->role == 'P' && Auth::user()->sheet)
                        ...
                        <div class="relative">
                            ...
                            <a href="{{ route('info.sinkronisasi') }}" class="absolute left-[5px] top-[-18px] flex flex-nowrap items-center gap-1 w-full">
                                <i class="fa-solid fa-circle-info text-[10px] text-red-500 hover:text-red-600"></i>
                                <span class="text-[10px] text-nowrap text-red-600 font-medium hover:text-red-600">Info</span>
                            </a>
                        </div>
                    @endif
                    <button type="submit"
